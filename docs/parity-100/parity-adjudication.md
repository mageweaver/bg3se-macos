...
- `Ext.Level`: five explicit deferrals account exactly for 20/25: three raycasts, tile debug info, and pathfinding creation (GetHeightsAt was exposed as a stub by the Wave 7 B3 truth pass, then implemented as the real multi-subgrid walk the same day) ([docs/deferrals.md:16](/Users/tomdimino/Desktop/Programming/game-modding/bg3/bg3se-macos/docs/deferrals.md:16)).
